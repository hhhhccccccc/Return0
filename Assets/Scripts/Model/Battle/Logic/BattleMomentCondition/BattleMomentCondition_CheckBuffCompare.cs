...
public class BattleMomentCondition_CheckBuffCompare : BattleMomentCondition
{
    ...
    protected override bool OnCondition()
    {
        ...
        {
            var value1 = target1.GetBuffCountByID(Config.ParamList[1].ToInt());
            var value2 = target1.GetBuffCountByID(Config.ParamList[3].ToInt());
