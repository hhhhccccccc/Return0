...
{
    private List<float> Shields;
    public override void AddToUnit(int buffID, BattleUnit subject, BattleUnit spellCaster, int addCount, List<float> paramList = null)
    {
        Shields = new List<float>();
        base.AddToUnit(buffID, subject, spellCaster, addCount, paramList);
    }
