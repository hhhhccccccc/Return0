...
namespace cfg
{
public sealed partial class HeartMethod : Luban.BeanBase
{
    public HeartMethod(JSONNode _buf) 
    {
    ...
    public static HeartMethod DeserializeHeartMethod(JSONNode _buf)
    {
        return new HeartMethod(_buf);
    }
    ...
    public const int __ID__ = 855476391;
