...
namespace cfg
{
public sealed partial class BattleSkill : Luban.BeanBase
{
    public BattleSkill(JSONNode _buf) 
    {
    ...
    public static BattleSkill DeserializeBattleSkill(JSONNode _buf)
    {
        return new BattleSkill(_buf);
    }
    ...
    public const int __ID__ = 907207769;
